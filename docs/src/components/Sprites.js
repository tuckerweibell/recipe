...
/* we also have Sprites in packages/recipe/src/components because we didn't want to spend more time
  making /docs/src/components/Sprites compatible with jest
  if you add/remove/edit anything here, edit it in packages/recipe/src/components/Sprites too
*/
