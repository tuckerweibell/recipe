...
const RecipeLogo = ({className}) => (
  <svg className={className} viewBox="0 0 972.16 239.56">
    <g>
      <path
        fill="#fff"
...
const HeroDivider = ({className}) => (
  <svg className={className} fill="currentColor" viewBox="0 0 100 100" preserveAspectRatio="none">
