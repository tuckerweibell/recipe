import {ColorItem, ColorPalette, Meta, Story, Source, Typeset} from '@storybook/addon-docs';
import dedent from 'ts-dedent';
import TableOfContents from '../components/TableOfContents';
import metaParameters from '../utils/metaParameters';

<Meta title="Guides/Theming" parameters={{...metaParameters, viewMode: 'docs'}} />

export const Template = args => <Theming {...args} />;

<Story name="Theming">{Template.bind({})}</Story>

<TableOfContents
  links={[
    {label: 'Supported Themes', href: '#supported-themes'},
...
## Supported Themes <a id="supported-themes" />
