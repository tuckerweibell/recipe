...
<Meta title="Guides/Contributing" parameters={{...metaParameters, viewMode: 'docs'}} />

export const Template = args => <Contributing {...args} />;

<Story name="Contributing">{Template.bind({})}</Story>

<TableOfContents
  links={[
    {label: 'Bug fixes', href: '#bug-fixes'},
    {label: 'New components', href: '#new-components'},
    {label: 'Development', href: '#development'},
    {label: 'Start contributing', href: '#start-contributing'},
  ]}
/>
...
## New components <a id="new-components" />
...
## Start contributing <a id="start-contributing" />
