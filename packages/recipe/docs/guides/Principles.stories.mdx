...
<Meta title="Guides/Principles" parameters={{...metaParameters, viewMode: 'docs'}} />

export const Template = args => <Principles {...args} />;

<Story name="Principles">{Template.bind({})}</Story>

<TableOfContents
  links={[
    {label: 'Recipe Principles', href: '#recipe-principles'},
    {label: 'Contributing Principles', href: '#contributing-principles'},
  ]}
/>

# Principles

## Recipe Principles <a id="recipe-principles" />
...
## Contributing Principles <a id="contributing-principles" />
