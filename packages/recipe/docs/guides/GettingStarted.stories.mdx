...
<Meta title="Guides/GettingStarted" parameters={{...metaParameters, viewMode: 'docs'}} />

export const Template = args => <GettingStarted {...args} />;

<Story name="Getting Started">{Template.bind({})}</Story>

<TableOfContents
  links={[
    {label: 'Why Recipe?', href: '#why-recipe?'},
    {label: 'Components overview', href: '#components-overview'},
    {label: 'Considerations', href: '#considerations'},
    {label: 'Recipe themes', href: '#recipe-themes'},
    {label: 'Design setup', href: '#design-setup'},
...
## Components overview <a id="components-overview" />
...
## Considerations <a id="considerations" />
...
## Recipe themes <a id="recipe-themes" />
...
## Design setup <a id="design-setup" />
...
## Development setup <a id="development-setup" />
...
## Browser support <a id="browser-support" />
