...
<Meta title="Guides/Migration" parameters={{...metaParameters, viewMode: 'docs'}} />

export const Template = args => <MigrationV14 {...args} />;

<Story name="v14">{Template.bind({})}</Story>

<TableOfContents
  links={[
    {label: 'Prologue', href: '#prologue'},
    {label: 'Breaking Changes', href: '#breaking-changes'},
    {label: 'Extending Themes', href: '#extending-themes'},
    {label: 'Importing Theme Properties', href: '#importing-theme-properties'},
    {label: 'Migration Steps', href: '#migration-steps'},
  ]}
/>

# Migration to Recipe 14

## Prologue <a id="prologue" />
...
## Extending Themes <a id="extending-themes" />
...
## Importing Theme Properties <a id="importing-theme-properties" />
...
## Migration Steps <a id="migration-steps" />
