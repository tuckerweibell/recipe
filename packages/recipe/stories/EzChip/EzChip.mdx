...
import {EzAlert, EzChip, EzIcon} from '../../src';
...
EzChip supports theme palette properties (`primary`, `secondary`, `neutral`, `error`, `warning`, `info`, and `success`) as well as all supported [theme colors](http://localhost:8000/guides/theming/#colors) (ex. `common.neutral120`).
