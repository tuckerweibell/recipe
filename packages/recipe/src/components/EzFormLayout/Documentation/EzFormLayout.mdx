...
Use [EzLayout](?path=/docs/layout-ezlayout--docs) to arrange fields into groups, or to vary field layouts across different screen sizes and device types.
...
<RelatedComponents components={['EzAlert', 'EzField', 'EzLayout']} />
