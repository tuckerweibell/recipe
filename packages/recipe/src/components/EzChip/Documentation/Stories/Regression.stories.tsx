...
export const StatusVariantsWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
...
export const ClickableWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
...
export const DeletableWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
...
export const ClickableAndDeletableWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
      <DefaultEzChip
        {...clickable}
...
export const ClickableStatusVariants: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
...
export const DeletableStatusVariants: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
...
export const IconsAndFilledVariantWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
      ...
      <DefaultEzChip
        {...filled}
        {...icon}
        label="icon/filled - color secondary"
        color="secondary"
      />
...
export const IconsAndOutlinedVariantWithColors: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
      <DefaultEzChip
        {...outlined}
        {...icon}
        label="icon/outlined - color primary"
        color="primary"
      />
      <DefaultEzChip
        {...outlined}
      ...
      <DefaultEzChip
        {...outlined}
        {...icon}
        label="icon/outlined - color warning"
        color="warning"
      />
      ...
      <DefaultEzChip
        {...outlined}
        {...icon}
        label="icon/outlined - color success"
        color="success"
      />
      <DefaultEzChip
        {...outlined}
        {...icon}
        label="icon/outlined - color neutral"
        color="neutral"
      />
    </Stack>
  ),
...
export const IconsAndChipSizes: Story = {
  render: () => (
    <Stack alignItems="center" spacing={1}>
