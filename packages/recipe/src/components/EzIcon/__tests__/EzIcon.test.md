### Font Awesome Icons color and size
...
() => {
  ...
  return (
    <EzLayout>
      ...
      <EzIcon icon={faCoffee} color="secondary" />
      <EzIcon icon={faCoffee} color="error" />
...
() => {
  ...
  return (
    <EzLayout>
      <EzIcon icon={Pizza} />
      <EzIcon icon={Pizza} color="primary" />
      <EzIcon icon={Pizza} color="secondary" />
      <EzIcon icon={Pizza} color="error" />
...
() => {
  ...
  return (
    <EzLayout>
      <EzIcon icon={burgerIcon} />
      <EzIcon icon={burgerIcon} color="primary" />
      <EzIcon icon={burgerIcon} color="secondary" />
      <EzIcon icon={burgerIcon} color="error" />
