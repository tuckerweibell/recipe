...
<MigrationAlert component="ez-popover" />
...
- Be used when a more specific overlay component is available, such as [EzModal](?path=/docs/feedback-ezmodal--docs) or [EzTooltip](?path=/docs/feedback-eztooltip--docs).
...
<RelatedComponents components={['EzModal', 'EzTooltip']} />
