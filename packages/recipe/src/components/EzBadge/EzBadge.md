...
Out of the box, badges have a background color of `common.alert100` and font color of `common.neutral100`. Available theme variants: `default` (neutral), `primary`, `secondary`, `error`, `info`, `success`, and `warning`.
