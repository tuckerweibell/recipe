...
- Contain important information, or information vital to task completion. Use [EzFlashMessage](?path=/docs/feedback-ezflashmessage--docs) for important contextual information.
- Be used sparingly, and should contain minimal content.
- For interactive content, use [EzModal](path=/docs/feedback-ezmodal--docs) instead.
...
<RelatedComponents components={['EzField', 'EzFlashMessage', 'EzModal']} />
