...
<img
  src="/images/modal-anatomy.svg"
  alt="Image illustrating through labels the component parts of a standard-style modal, including a title and empty content areas for body content and dialog actions."
  width="800px"
/>
...
- `EzPreview` (image or illustration)
- `EzHeader` (title and other header content e.g. card actions)
- `EzContent` (body)
- `EzFooter` (footer)
  ...
  return (
    <>
      ...
      <EzModal isOpen={isOpen} onDismiss={close}>
        ...
        <EzFooter>
          <EzLayout layout="basic">
            <EzButton onClick={close}>Order now</EzButton>
            <EzButton variant="outlined" onClick={close}>
              Close
            </EzButton>
          </EzLayout>
